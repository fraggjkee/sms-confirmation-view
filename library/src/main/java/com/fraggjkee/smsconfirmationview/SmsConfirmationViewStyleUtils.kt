    ...
    fun getDefault(context: Context): SmsConfirmationView.Style {
        if (defaultStyle == null) {
            ...
            val symbolViewStyle = SymbolView.Style(
                ...
                backgroundColor = context.getThemeColor(MaterialR.attr.colorSurface),
                borderColor = context.getThemeColor(androidx.appcompat.R.attr.colorPrimary),
                borderColorActive = context.getThemeColor(androidx.appcompat.R.attr.colorPrimary),
